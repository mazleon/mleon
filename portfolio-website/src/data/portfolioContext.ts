...
export const PORTFOLIO_CONTEXT = {
  personal: {
    ...
    social: {
      ...
      googleScholar:
        "https://scholar.google.com/citations?user=UsoRY-QAAAAJ&hl=en",
    },
  },
  ...
  projects: [
    {
      ...
      description:
        "AI-powered system transforming tobacco leaf grading with 95% accuracy using custom CNN architectures for BAT (British American Tobacco).",
      technologies: [
        "Python",
        "TensorFlow",
        "OpenCV",
    ...
    },
    {
      ...
      description:
        "Real-time security intelligence platform using unsupervised learning to detect behavioral anomalies.",
      technologies: [
        "Python",
        "PyTorch",
        "Kafka",
    ...
    },
    {
      ...
      description:
        "Context-aware conversational agent using orchestrated NLP modules for superior customer engagement.",
      technologies: [
        "Python",
        "NLTK",
        "TensorFlow",
    ...
    },
    {
      ...
      description:
        "High-security identity verification platform with anti-spoofing liveness detection capabilities.",
      technologies: [
        "Python",
        "Dlib",
        "OpenCV",
