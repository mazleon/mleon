...
const Blog = () => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      description: "The real challenges of scaling a biometric onboarding platform: compliance constraints, demographic shifts, and shadow-mode deployments.",
